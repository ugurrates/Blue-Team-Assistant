...
class ThreatIntelExtended:
    ...
    async def check_talos(self, ip: str) -> Dict:
        """Talos Intelligence (Cisco) - IP reputation."""
        # Talos doesn't have free API, using reputation check
        try:
            url = f'https://talosintelligence.com/reputation_center/lookup?search={ip}'
            # Note: This is web scraping, not official API
            return {
            ...
            return {'source': 'Talos Intelligence', 'status': 'Error', 'found': False}
